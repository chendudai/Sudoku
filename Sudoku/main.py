...
if __name__ == "__main__":
    ...
    if device == torch.device("cuda:0"):
        with open("FC_stats_LR0.0001_batchSize512_step2_patience10.txt", "rb") as fp:  # Unpickling
            b = pickle.load(fp)
    else:
    ...
    # net, numDeleted, epochsOfDelete, train_acc, train_loss, val_acc, val_loss = \
    #     trainNet(net, batch_size, LR, step, patience, valCalcFreq, train_loader, val_loader, device)
    quizzesBoards, deltas = testNet(net, 50, test_loader, device)
