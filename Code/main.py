...
if __name__ == "__main__":
    ...
    valCalcFreq = 5
    maxDelete = 150
    # # 0 - unproper + repetetions. 3 - propr + rept,
    deleteType = 3
    ...
    # quizzesBoards, deltas = testNet(net, test_loader, device)
    ...
    with open('net_dicts/dict and stats FC_1/stats_FC_1_deleteProperlyWithRept_maxDel150_7epochEachDel_data48_58.txt', 'wb') as handle:
    ...
    # plotTrackCell(track_data['trackPreds'], track_data['trackBoards'], track_data['trackBoardsSolutions'], x=1, y=1)
    # simulateDeleting(pullNum=150, rangeNum=56)
